...
| HashMap       |         | 39.99ns   | 130.55ns | 25.00M/s   | 40.00 MB  |
| Binary Search |         | 40.89ns   | 79.06ns  | 24.46M/s   | -         |
| BTreeMap      |         | 84.21ns   | 99.32ns  | 11.87M/s   | 16.83 MB  |
...
### Benchmark ConfigurationQuery Count: 1500000Data Sizes: 10,000, 100,000, 1,000,000Epsilon Values: 32, 64, 128

---

### Epsilon (ε) Explained

_Epsilon (ε) controls the accuracy-speed trade-off:_

_Mathematical definition: ε defines the maximum absolute error between the predicted position and the actual position in the data array. When calling `load(data, epsilon, ...)`, ε guarantees |pred - actual| ≤ ε, where positions are indices within the data array of length `data.len()`._

_Example: For 1M elements with ε=32, if the actual key is at position 1000:_
...
- OS: macOS 26.1 (arm64)
- CPU: Apple M2 Max- Cores: 12- Memory: 64.0GB
...
| jdb_pgm   | 128     | 26.15ns  | 96.65ns  | 38.25M/s | 256.00 KB |
| HashMap   |         | 39.99ns  | 130.55ns | 25.00M/s | 40.00 MB  |
| 二分查找  |         | 40.89ns  | 79.06ns  | 24.46M/s | -         |
| BTreeMap  |         | 84.21ns  | 99.32ns  | 11.87M/s | 16.83 MB  |

### 精度对比: jdb_pgm vs pgm_index

| 数据大小  | Epsilon | jdb_pgm (Max) | jdb_pgm (Avg) | pgm_index (Max) | pgm_index (Avg) |
| --------- | ------- | ------------- | ------------- | --------------- | --------------- |
| 1,000,000 | 32      | 32            | 11.35         | 256             | 127.48          |
| 1,000,000 | 64      | 64            | 22.59         | 512             | 255.39          |
| 1,000,000 | 128     | 128           | 46.80         | 1024            | 511.28          |
...
| 数据大小  | Epsilon | jdb_pgm (Time) | pgm_index (Time) | 加速比 |
| --------- | ------- | -------------- | ---------------- | ------ |
| 1,000,000 | 32      | 1.28ms         | 1.27ms           | 0.99x  |
| 1,000,000 | 64      | 1.28ms         | 1.20ms           | 0.94x  |
| 1,000,000 | 128     | 1.28ms         | 1.26ms           | 0.98x  |

### 基准测试配置查询次数: 1500000数据大小: 10,000, 100,000, 1,000,000Epsilon 值: 32, 64, 128
...
- 系统: macOS 26.1 (arm64)
- CPU: Apple M2 Max- 核心数: 12- 内存: 64.0GB
- Rust 版本: rustc 1.94.0-nightly (8d670b93d 2025-12-31)
