...
macro_rules! resolve_set {
    ($resolver:ty) => {
        ...
        const _: () = {
            fn _assert_impl<T: $crate::resolve::sys::ExternResolve>() {}
        ...
        pub fn __compio_resolve_create(host: &str, port: u16) -> *mut () {
            let resolver = ::std::boxed::Box::new(<$resolver as $crate::resolve::sys::ExternResolve>::new(host, port));
        ...
        > {
            ...
            $crate::resolve::sys::ExternResolve::poll(resolver, waker)
        }
