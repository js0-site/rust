...
const combine = (data, lang) => {
  ...
  const mainTitle = lang === "en" ? "u64_2 vs vb Benchmark" : "u64_2 vs vb 性能评测";
  ...
  const sortedByEncode = [...resultsWithThroughput].sort((a, b) => b.encode_throughput - a.encode_throughput);
  const sortedByDecode = [...resultsWithThroughput].sort((a, b) => b.decode_throughput - a.decode_throughput);
