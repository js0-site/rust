...
#[cfg(feature = "binary-fuse")]
pub use bf8::{Bf8, Bf8Ref};
#[cfg(feature = "binary-fuse")]
pub use bf16::{Bf16, Bf16Ref};
#[cfg(feature = "binary-fuse")]
pub use bf32::{Bf32, Bf32Ref};

/// Type alias for `Bf8` - 8-bit Binary Fuse filter.
/// 8位 Binary Fuse 过滤器的类型别名。
#[cfg(feature = "binary-fuse")]
pub type BinaryFuse8 = Bf8;

/// Type alias for `Bf8Ref` - 8-bit Binary Fuse reference filter.
/// 8位 Binary Fuse 引用过滤器的类型别名。
#[cfg(feature = "binary-fuse")]
pub type BinaryFuse8Ref<'a> = Bf8Ref<'a>;

/// Type alias for `Bf16` - 16-bit Binary Fuse filter.
/// 16位 Binary Fuse 过滤器的类型别名。
#[cfg(feature = "binary-fuse")]
pub type BinaryFuse16 = Bf16;

/// Type alias for `Bf16Ref` - 16-bit Binary Fuse reference filter.
/// 16位 Binary Fuse 引用过滤器的类型别名。
#[cfg(feature = "binary-fuse")]
pub type BinaryFuse16Ref<'a> = Bf16Ref<'a>;

/// Type alias for `Bf32` - 32-bit Binary Fuse filter.
/// 32位 Binary Fuse 过滤器的类型别名。
#[cfg(feature = "binary-fuse")]
pub type BinaryFuse32 = Bf32;

/// Type alias for `Bf32Ref` - 32-bit Binary Fuse reference filter.
/// 32位 Binary Fuse 引用过滤器的类型别名。
#[cfg(feature = "binary-fuse")]
pub type BinaryFuse32Ref<'a> = Bf32Ref<'a>;
