...
mod jdb_impl {
  ...
  impl FilterBench for JdbBf8 {
    ...
    fn memory_usage(&self) -> usize {
      std::mem::size_of::<Bf8>() + self.0.fingerprints.len()
    }
  }
  ...
  impl FilterBench for JdbBf16 {
    ...
    fn memory_usage(&self) -> usize {
      std::mem::size_of::<Bf16>() + self.0.fingerprints.len() * 2
    }
  }
  ...
  impl FilterBench for JdbBf32 {
    ...
    fn memory_usage(&self) -> usize {
      std::mem::size_of::<Bf32>() + self.0.fingerprints.len() * 4
    }
  }
}
...
mod xorf_impl {
  use xorf::{Bf8, BinaryFuse16, BinaryFuse32, Filter};
