use jdb_xorf::{
  BinaryFuse8, BinaryFuse8Ref, BinaryFuse16, BinaryFuse16Ref, BinaryFuse32, BinaryFuse32Ref,
...
macro_rules! test_dma_roundtrip {
  ($filter_ty:ty, $ref_ty:ty) => {
    ...
    let mut desc = vec![0u8; <$filter_ty>::DESCRIPTOR_LEN];
...
fn test_bfuse8_initialization() {
  test_initialization_gen::<BinaryFuse8>();
}
#[test]
fn test_bfuse16_initialization() {
  test_initialization_gen::<BinaryFuse16>();
}
#[test]
fn test_bfuse32_initialization() {
  test_initialization_gen::<BinaryFuse32>();
}

#[test]
fn test_bfuse8_bits_per_entry() {
  test_bits_per_entry_gen::<BinaryFuse8>(8.0, 9.1);
}
#[test]
fn test_bfuse16_bits_per_entry() {
  test_bits_per_entry_gen::<BinaryFuse16>(16.0, 18.1);
}
#[test]
fn test_bfuse32_bits_per_entry() {
  test_bits_per_entry_gen::<BinaryFuse32>(32.0, 36.2);
}

#[test]
fn test_bfuse8_false_positives() {
  test_false_positives_gen::<BinaryFuse8>(0.406);
}
#[test]
fn test_bfuse16_false_positives() {
  test_false_positives_gen::<BinaryFuse16>(0.0025);
}
#[test]
fn test_bfuse32_false_positives() {
  test_false_positives_gen::<BinaryFuse32>(0.0000000000000001);
}
...
fn test_bfuse8_duplicates() {
  let _ = BinaryFuse8::try_from(vec![1, 2, 1]).unwrap();
}
#[test]
#[cfg(debug_assertions)]
#[should_panic]
fn test_bfuse16_duplicates() {
  let _ = BinaryFuse16::try_from(vec![1, 2, 1]).unwrap();
}
#[test]
#[cfg(debug_assertions)]
#[should_panic]
fn test_bfuse32_duplicates() {
  let _ = BinaryFuse32::try_from(vec![1, 2, 1]).unwrap();
}

#[test]
fn test_bfuse8_dma_roundtrip() {
  test_dma_roundtrip!(BinaryFuse8, BinaryFuse8Ref);
}
#[test]
fn test_bfuse16_dma_roundtrip() {
  test_dma_roundtrip!(BinaryFuse16, BinaryFuse16Ref);
}
#[test]
fn test_bfuse32_dma_roundtrip() {
  test_dma_roundtrip!(BinaryFuse32, BinaryFuse32Ref);
}
